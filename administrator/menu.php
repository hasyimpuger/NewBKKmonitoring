...
if ($_SESSION['leveluser']=='admin'){
  ...
  while ($m=mysqli_fetch_array($hasil)){  
    echo "<li><a href=\"$m[link]\"><i class=\"fa fa-laptop\"></i><span> $m[nama_modul] </span></a></li>";
  }
}
...
elseif($_SESSION['leveluser']=='pembimbing') {
    $query = "SELECT * FROM modul WHERE status='pembimbing' AND aktif ='Y' ORDER BY urutan";
    $hasil = mysqli_query($koneksi,$query);
    while ($m = mysqli_fetch_array($hasil)) {
       echo "<li><a href=\"$m[link]\"><i class=\"fa fa-laptop\"></i><span> $m[nama_modul] </span></a></li>";
    }
