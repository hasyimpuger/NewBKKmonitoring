              ...
              <input type='hidden' name='id' value='$r[id_modul]'>
                <div class='col-md-12'>
                  ...
                  <input type=hidden name=id value='$r[id_modul]'>
                    ...
                    <tr><th scope='row'>Status</th>      <td>"; if ($r['status']=='admin'){ echo "<input type='radio' name='status' value='admin' checked> Admin &nbsp; <input type='radio' name='status' value='user'> User &nbsp; <input type='radio' name='status' value='pembimbing'>"; }else{ echo "<input type='radio' name='status' value='admin'> Admin &nbsp; <input type='radio' name='status' value='user' checked> User <input type='text' name='status' >"; } echo "</td></tr>
